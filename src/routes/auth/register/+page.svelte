...
<div class="grid grid-cols-[35rem_auto] h-screen">
  <div class="p-6 flex flex-col justify-center max-w-md mx-auto">
    <div class="flex items-center gap-3 mb-6">
      <img src={Logo} alt="Logo" class="w-6 h-6" />
      <h1 class="text-blue-400 text-xl font-montserrat font-bold">project title</h1>
    </div>
  ...
  <img src="https://placekitten.com/1920/1080" alt="" class="object-cover h-full" />
</div>
