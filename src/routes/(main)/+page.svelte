...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
  <div class="card relative overflow-hidden">
    <IconifyIcon icon="material-symbols:package-2" class="w-16 sm:w-24 lg:w-32 h-16 sm:h-24 lg:h-32 text-green-400 absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/4 sm:translate-x-1/3" />
  ...
  <div class="card relative overflow-hidden">
    <IconifyIcon
      ...
      class="w-16 sm:w-24 lg:w-32 h-16 sm:h-24 lg:h-32 text-emerald-400 absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/4 sm:translate-x-1/3"
    />
